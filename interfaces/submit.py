...
class SUBMIT_TRACE:
    def __init__(self, config, newBranchHead, changesTrace, pullRequests, nameResolution, nameResolutionRoot, nameTrie, dataTrie, reviewsTrace, socialTrace, sprouts, sproutSelectionTrace):
        self.config=config
